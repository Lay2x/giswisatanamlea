...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('dashboard.index') }}" class="brand-link text-center">
      <span class="brand-text font-weight-light"><img src="{{ asset('logo/'.$konf->favicon_setting) }}" style="width: 120px; align: center" alt=""></span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('tipewisata.index') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tipe Wisata</p>
                </a>
            </ul>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php $cpy = date('Y'); echo $cpy; ?><a href="{{ route('dashboard.index') }}"> ADev</a>.</strong> All rights reserved.
  </footer>
...
<script type="text/javascript">
  $('.show_confirm').click(function(event) {
   ...
   $('.show_publish').click(function(event) {
       var form =  $(this).closest("form");
       var name = $(this).data("name");
       event.preventDefault();
       swal({
           title: `Ingin Publish Komen Ini??`,
           text: "Jika Iya maka Komentar ini Akan Muncul Di Kolom Review.",
           buttons: true,
           dangerMode: false,
       })
       .then((willDelete) => {
   ...
   $('.show_unpublish').click(function(event) {
       var form =  $(this).closest("form");
       var name = $(this).data("name");
       event.preventDefault();
       swal({
           title: `Ingin Unpublish Komen Ini??`,
           text: "Jika Iya maka Komentar ini Akan Ditarik Dari Kolom Review.",
           buttons: true,
           dangerMode: false,
       })
       .then((willDelete) => {
