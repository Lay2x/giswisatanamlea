        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('visimisi.update', $visi->id_visimisi) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    
                    <div class="form-group mb-2">
                        <label for="">Visi</label>
                        <textarea name="visi" id="editor" cols="30" rows="10">{{ $visi->visi }}</textarea>
                    </div>
                    <div class="form-group mb-2">
                        <label for="">Misi</label>
                        <textarea name="misi" id="editor" cols="30" rows="10">{{ $visi->misi }}</textarea>
                    </div>
